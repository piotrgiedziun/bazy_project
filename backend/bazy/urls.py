...
urlpatterns = patterns('bazy.views',
    ...
    url(r'^panel/oplat/chart/1$', views.panel_oplaty_chart_1, name='panel_oplaty_chart_1'),
    url(r'^panel/oplat/chart/2$', views.panel_oplaty_chart_2, name='panel_oplaty_chart_2'),
    url(r'^panel/oplat/statistics$', views.panel_oplaty_statistics, name='panel_oplaty_statistics'),
